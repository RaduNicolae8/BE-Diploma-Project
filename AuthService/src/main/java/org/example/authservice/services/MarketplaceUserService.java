...
import org.example.authservice.mappers.MarketplaceUserMapper;
import org.example.authservice.models.MarketplaceUser;
import org.example.authservice.repositories.MarketplaceUserRepository;
...
public class MarketplaceUserService extends GenericService<MarketplaceUser, MarketplaceUserDTO>{
    ...
    public MarketplaceUserDTO findByUsername(String email) {
        ...
        log.info("User found: {}", byUsername.get().getEmail());
